Cenário: Feedback de construtivo (CT-1)
    Dado que estou na página de feedback
    Quando clico na opção de feedback construtivo
...
Cenário: Feedback construtivo sem recipiente (CT-2)
    Dado que estou na página de feedback
    Quando clico na opção de feedback construtivo
...
Cenário: Feedback de construtivo sem comportamento (CT-3)
    Dado que estou na página de feedback
    Quando clico na opção de feedback construtivo
...
Cenário: Feedback construtivo sem texto (CT-4)
    Dado que estou na página de feedback
    Quando clico na opção de feedback construtivo
    E seleciono um comportamento atribuído
    E escrevo um feedback
...
Cenário: Feedback construtivo com texto longo demais (CT-5)
    Dado que estou na página de feedback
    Quando clico na opção de feedback construtivo
...
Cenário: Feedback construtivo com usuário inexistente (CT-6)
    Dado que estou na página de feedback
    Quando clico na opção de feedback construtivo
...
Cenário: Feedback construtivo anônimo (CT-7)
    Dado que preenchi todos os campos de feedback construtivo corretamente
